  ...
  var update = {
    'darwin': {
      'ia32': {
        ...
        signature: 'https://s3.amazonaws.com/breach_releases/breach/v0.3.5-alpha.1/breach-v0.3.5-alpha.1-darwin-ia32.tar.gz.sha1sum.asc'
      }
    },
    'linux': {
      'x64': {
        ...
        signature: 'https://s3.amazonaws.com/breach_releases/breach/v0.3.5-alpha.1/breach-v0.3.5-alpha.1-linux-x64.tar.gz.sha1sum.asc'
      }
    }
  };
